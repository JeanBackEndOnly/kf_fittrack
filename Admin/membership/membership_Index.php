...
<body>
    <div class="header">
        <div class="search-form">
            <form action="membership_Index.php" method="post">
                <input type="text" name="search" placeholder="Search Member:">
                <button class="search-button" id="search-button"><img src="../../image/search-user.png" id="search-img"></button>
            </form>
            <a href="register_Index.php" class="add-button"><img src="../../image/adding-icon.png"></a>
        </div>
                ...
                if (isset($_POST['search'])) {
                    ...
                    try {
                        if (is_numeric($searchQuery)) {
                            $query = "SELECT members.*, users.*, contract.* FROM members
                        ...
                        if ($searchResult) {
                            ...
                            echo '<div class="back-to-home">';
                                echo '<a href="membership_Index.php" id="back-to-home"><img src="../../image/arrow-icon.png" id="arrow-back"></a>';
                            echo '</div>';
                            echo '<div class="expired-ul">';
                                ...
                                echo '<div class="row-contract">';
                                    ...
                                    echo '<li id="renewal-li">AGE: ' . $searchResult["age"] . '</li>';
                                echo '</div>';
                                echo '<div class="contract-div">';
                                    echo '<li id="expiration-li">GENDER: ' . $searchResult["gender"] . '</li>';
                                echo '</div>';
                                echo '</div>';
                                ...
                                echo '<button class="deleteButton" onclick="showPopup(' . $searchResult['id'] . ')" id="buttons-delete">
                                        <img src="../../image/delete-icon.png" id="delete-icon">DELETE
                                    </button>';
                                ...
                                echo '<div id="confirmPopup-' . $searchResult['id'] . '" class="popup" style="display: none;">
                                        <div class="popup-content">
                                            ...
                                            <div class="button-popup">
                                                <form action="../functionalities/membership_Delete.php?member_id=' . $searchResult["member_id"] . '" method="post">
                                                    <input type="hidden" name="id" value="' . $searchResult['id'] . '">
                                                    <input type="hidden" name="member_id" value="' . $searchResult["member_id"] . '">
                                                    <input type="hidden" name="contract_id" value="' . $searchResult["contract_id"] . '">
                        ...
                        echo '</ul>';
                            ...
                            echo '<div class="no-result-found">';
                                ...
                                echo '<a href="membership_Index.php">>>view other members<<</a>';
                            echo '</div>';
                        }
                    ...
                    $sql = "SELECT members.*, users.*, contract.* FROM members
                    LEFT JOIN contract ON members.member_id = contract.members_id
                    ...
                    foreach ($result as $row) {
                        echo '<ul class="image-div">';
                            echo '<div class="expired-ul">';
                                ...
                                echo '<div class="row-contract">';
                                    echo '<div class="expiration-div">';
                                    echo '<li id="renewal-li">AGE: ' . $row["age"] . '</li>';
                                echo '</div>';
                                echo '<div class="contract-div">';
                                    echo '<li id="expiration-li">GENDER: ' . $row["gender"] . '</li>';
                                echo '</div>';
                                echo '</div>';
                                echo '<div class="buttons-domain-expansion">';
                                ...
                                echo '<div id="confirmPopup-' . $row['id'] . '" class="popup" style="display: none;">
                                        <div class="popup-content">
                                            <h2>Are you sure you want to delete this member?</h2>
                                            <div class="button-popup">
                                                <form action="../functionalities/membership_Delete.php?member_id=' . $row["member_id"] . '" method="post">
